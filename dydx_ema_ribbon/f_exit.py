  ...
  """
    ...
    if is_open:
        ...
        if side == "":
            ...
            send_message(f"No exit signal... BTC-USD Last Price: {price}. Side: {position}, Price: {entry_price[0]}, Size: {size}")
            return
        ...
        try:
            ...
            send_message(f"Exit signal detected! Closing position... "
                         f"Last Price: {price}. Side: {position}, Price: {entry_price}, Size: {size}")
